...
const SvgDangerElectricity = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      d="M60.5 60.5h-57c-1.3 0-2.4-.7-3-1.8-.6-1.1-.6-2.4 0-3.5L29 6.2c.6-1.1 1.8-1.7 3-1.7 1.3 0 2.4.7 3 1.7l28.5 49c.6 1.1.6 2.4 0 3.5s-1.7 1.8-3 1.8ZM31.6 7.7l-28.5 49c-.1.2-.1.4 0 .5.1.1.2.3.4.3h57c.3 0 .4-.2.4-.2.1-.1.1-.3 0-.5l-28.5-49c-.1-.2-.3-.2-.4-.2-.1 0-.3-.1-.4.1Z"
      fill="currentColor"
    />
    <path
