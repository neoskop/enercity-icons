...
const SvgAttention = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      d="M33.5 23.5h-3c-.42 0-.83.18-1.11.5-.28.31-.42.74-.38 1.16l1.49 14.5a1.496 1.496 0 0 0 2.98.01l1.51-14.5c.04-.42-.09-.84-.38-1.16-.29-.32-.69-.5-1.11-.5v-.01Zm1 23a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Z"
      fill="currentColor"
    />
    <path
      fillRule="evenodd"
