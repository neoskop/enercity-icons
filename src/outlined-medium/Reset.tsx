...
const SvgReset = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    />
    <path
      d="M12 12.75c.24 0 .473-.12.607-.315l3.75-5.25a.745.745 0 0 0-.172-1.043.745.745 0 0 0-1.042.173l-3.526 4.935H7.5a.752.752 0 0 0-.75.75c0 .412.338.75.75.75H12Z"
      fill="currentColor"
    />
  </svg>
);
