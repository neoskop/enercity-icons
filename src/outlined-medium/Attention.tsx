...
const SvgAttention = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    />
    <path
      d="M12.752 8.25h-1.5c-.218 0-.42.09-.563.255a.735.735 0 0 0-.18.592l.743 6a.75.75 0 0 0 .742.66.752.752 0 0 0 .743-.66l.757-6a.743.743 0 0 0-.18-.592.735.735 0 0 0-.562-.255Zm-.75 10.5a1.125 1.125 0 1 0 0-2.25 1.125 1.125 0 0 0 0 2.25Z"
      fill="currentColor"
    />
  </svg>
);
